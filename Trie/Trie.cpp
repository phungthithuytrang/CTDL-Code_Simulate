...
int main()
{
	outfile1.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\docTrie.txt", ios::out | ios::trunc);
	outfile2.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\sosanhTrie.txt", ios::out | ios::trunc);
