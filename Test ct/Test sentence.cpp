...
int main()
{
	outfile2.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\kqSen.txt", ios::out | ios::trunc);
	outfile1.open("E:\\CTDL\\CTDLProject\\Test ct\\Simulate\\timecompareSen.txt", ios::out | ios::trunc);
